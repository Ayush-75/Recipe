...
import com.example.recipe.databinding.FavoritesRecipesRowLayoutBinding
import com.example.recipe.ui.fragments.favorites.FavRecipeFragmentDirections
import com.example.recipe.utils.RecipesDiffutils
import com.example.recipe.viewmodels.MainViewModel
import com.google.android.material.snackbar.Snackbar

class FavoritesRecipeAdapter(private val requireActivity: FragmentActivity,
        ...
        holder.binding.favRecipesRowLayout.setOnClickListener {
            if (multiSelection) {
                ...
                holder.itemView.findNavController()
                    .navigate(FavRecipeFragmentDirections.actionFavRecipeFragmentToDetailsActivity(currentRecipe.result))
            }
        }
